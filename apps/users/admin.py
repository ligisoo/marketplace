...
class UserAdmin(BaseUserAdmin):
    ...
    list_filter = ('is_staff', 'is_active', 'userprofile__is_pro', 'userprofile__is_verified')
...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'is_pro', 'pro_expires_at', 'is_verified', 'created_at')
    list_filter = ('is_pro', 'is_verified', 'created_at')
